...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb_entity', type=str, default='Quynhlx', help='Wandb entity')
    parser.add_argument('--wandb_project', type=str, default='yolo5', help='Wandb project name')
